...
// {song_uri: "", song_id: "", user_name: ""} if the queue is empty.
...
//             res.status(200);
//             if (result.queue.length == 0) {
//                 res.send({song_uri: "", song_id: "", user_name: ""});
//             } else {
//                 var new_queue = result.queue;
...
//                           user_name: result.queue[0].user_name});
//             }
//         });
//     });
// })
...
//             collection.findOne({'users.user_name': u_id}, (error, u_result) => {
//                 if (!u_result) {
//                     res.status(400);
...
//                 var new_queue = result.queue;
//                 new_queue.push({song_uri: uri, song_id: id, user_name: u_id});
//                 collection.updateOne({code: room_code},
//                                      {code: room_code,
//                                       token: result.token,
//                                       time_created: result.time_created,
...
// Use:        GET /getlist
// Parameters: code - 4 digit string room code
// Returns:    [{song_uri, song_id, user_name}]
// Notes:      n/a
//   .get('/getlist', (req, res) => {
//     var room_code = req.query.code;
